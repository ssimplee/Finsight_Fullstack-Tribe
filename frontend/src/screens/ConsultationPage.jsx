...
function validateCaseForm(caseForm) {
  ...
  if (!caseForm.symptomDuration.trim()) {
    nextErrors.symptomDuration =
      "Add the symptom duration so FinSight can separate acute and chronic patterns.";
  }

  if (!caseForm.mortalityTrend.trim()) {
    nextErrors.mortalityTrend =
      "Describe the recent mortality trend before continuing.";
  }
